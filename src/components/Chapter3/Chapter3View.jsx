...
const Chapter3View = () => {
  const [activeTab, setActiveTab] = useState('notes'); // 'calculations' or 'notes'

  return (
    <div className="animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Chapitre 3: Pathologies & Dysbiose</h2>
      </div>
      ...
      <div className="bg-white p-1 rounded-lg shadow-sm border border-gray-200 inline-flex mb-8 w-full md:w-auto">
        ...
        >
          <ShieldAlert size={16} />
          <span>Mécanismes Spécifiques</span>
        </button>
      </div>
